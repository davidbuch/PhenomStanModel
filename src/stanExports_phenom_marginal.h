...
namespace model_phenom_marginal_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_phenom_marginal");
    reader.add_event(137, 135, "end", "model_phenom_marginal");
    return reader;
}
#include <stan_meta_header.hpp>
class model_phenom_marginal
  : public stan::model::model_base_crtp<model_phenom_marginal> {
private:
        int N;
        int P;
        int K;
        ...
        std::vector<double> marginal_alpha_prior;
        std::vector<double> marginal_lengthscale_prior;
        ...
        std::vector<double> x;
public:
    model_phenom_marginal(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_phenom_marginal_namespace::model_phenom_marginal";
        ...
        try {
            ...
            validate_non_negative_index("marginal_alpha_prior", "2", 2);
            context__.validate_dims("data initialization", "marginal_alpha_prior", "double", context__.to_vec(2));
            marginal_alpha_prior = std::vector<double>(2, double(0));
            vals_r__ = context__.vals_r("marginal_alpha_prior");
            pos__ = 0;
            size_t marginal_alpha_prior_k_0_max__ = 2;
            for (size_t k_0__ = 0; k_0__ < marginal_alpha_prior_k_0_max__; ++k_0__) {
                marginal_alpha_prior[k_0__] = vals_r__[pos__++];
            }
            current_statement_begin__ = 10;
            validate_non_negative_index("marginal_lengthscale_prior", "2", 2);
            context__.validate_dims("data initialization", "marginal_lengthscale_prior", "double", context__.to_vec(2));
            marginal_lengthscale_prior = std::vector<double>(2, double(0));
            vals_r__ = context__.vals_r("marginal_lengthscale_prior");
            pos__ = 0;
            size_t marginal_lengthscale_prior_k_0_max__ = 2;
            for (size_t k_0__ = 0; k_0__ < marginal_lengthscale_prior_k_0_max__; ++k_0__) {
                marginal_lengthscale_prior[k_0__] = vals_r__[pos__++];
            }
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        current_statement_begin__ = 22;
        if (!(context__.contains_r("marginal_alpha")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable marginal_alpha missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("marginal_alpha");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "marginal_alpha", "double", context__.to_vec());
        double marginal_alpha(0);
        marginal_alpha = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0, marginal_alpha);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable marginal_alpha: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 23;
        if (!(context__.contains_r("marginal_lengthscale")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable marginal_lengthscale missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("marginal_lengthscale");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "marginal_lengthscale", "double", context__.to_vec());
        double marginal_lengthscale(0);
        marginal_lengthscale = vals_r__[pos__++];
        try {
            writer__.scalar_lub_unconstrain(ls_min, ls_max, marginal_lengthscale);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable marginal_lengthscale: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 24;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 22;
            local_scalar_t__ marginal_alpha;
            (void) marginal_alpha;  // dummy to suppress unused var warning
            if (jacobian__)
                marginal_alpha = in__.scalar_lb_constrain(0, lp__);
            else
                marginal_alpha = in__.scalar_lb_constrain(0);
            current_statement_begin__ = 23;
            local_scalar_t__ marginal_lengthscale;
            (void) marginal_lengthscale;  // dummy to suppress unused var warning
            if (jacobian__)
                marginal_lengthscale = in__.scalar_lub_constrain(ls_min, ls_max, lp__);
            else
                marginal_lengthscale = in__.scalar_lub_constrain(ls_min, ls_max);
            current_statement_begin__ = 24;
            ...
            lp_accum__.add(inv_gamma_log<propto__>(marginal_lengthscale, get_base1(marginal_lengthscale_prior, 1, "marginal_lengthscale_prior", 1), get_base1(marginal_lengthscale_prior, 2, "marginal_lengthscale_prior", 1)));
            current_statement_begin__ = 62;
            lp_accum__.add(gamma_log<propto__>(marginal_alpha, get_base1(marginal_alpha_prior, 1, "marginal_alpha_prior", 1), get_base1(marginal_alpha_prior, 2, "marginal_alpha_prior", 1)));
            {
            ...
            stan::math::assign(cov, cov_exp_quad(x, marginal_alpha, marginal_lengthscale));
            current_statement_begin__ = 68;
            for (int n = 1; n <= N; ++n) {
                current_statement_begin__ = 69;
                stan::model::assign(cov, 
                            stan::model::cons_list(stan::model::index_uni(n), stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list())), 
                            (get_base1(cov, n, n, "cov", 1) + square(sigma)), 
                            "assigning variable cov");
            }
            ...
            for (int i = 1; i <= P; ++i) {
                ...
                lp_accum__.add(multi_normal_cholesky_log<propto__>(get_base1(y, i, "y", 1), multiply(get_base1(design, i, "design", 1), f), L_cov));
            }
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        ...
        names__.push_back("marginal_alpha");
        names__.push_back("marginal_lengthscale");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_phenom_marginal_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        double marginal_alpha = in__.scalar_lb_constrain(0);
        vars__.push_back(marginal_alpha);
        double marginal_lengthscale = in__.scalar_lub_constrain(ls_min, ls_max);
        vars__.push_back(marginal_lengthscale);
            ...
            for (int l = 1; l <= L; ++l) {
                ...
                for (int n = 1; n <= N; ++n) {
                    ...
                    stan::model::assign(Sigma, 
                                stan::model::cons_list(stan::model::index_uni(n), stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list())), 
                                (get_base1(Sigma, n, n, "Sigma", 1) + 1e-8), 
                        ...
                        for (int i = 1; i <= N; ++i) {
                            ...
                            for (int j = 1; j <= N; ++j) {
                                ...
                                stan::model::assign(dK, 
                                            ...
                                            (get_base1(dK, i, j, "dK", 1) * (-(lsInv) * diff)), 
                                            "assigning variable dK");
                                current_statement_begin__ = 122;
                                stan::model::assign(ddK, 
                                            stan::model::cons_list(stan::model::index_uni(i), stan::model::cons_list(stan::model::index_uni(j), stan::model::nil_index_list())), 
                                            ((get_base1(ddK, i, j, "ddK", 1) * (1. - ((lsInv * diff) * diff))) * lsInv), 
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        param_name_stream__.str(std::string());
        param_name_stream__ << "marginal_alpha";
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "marginal_lengthscale";
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
...
typedef model_phenom_marginal_namespace::model_phenom_marginal stan_model;
#ifndef USING_R
