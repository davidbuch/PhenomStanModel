...
#include "stanExports_phenom_marginal.h"

RCPP_MODULE(stan_fit4phenom_marginal_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_phenom_marginal")
